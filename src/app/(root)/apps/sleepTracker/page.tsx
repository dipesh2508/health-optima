...
const page = () => {
  return (
    <main>
      <h1 className="mt-8 text-center font-serif text-4xl font-semibold text-dark-primary">
        Sleep Tracker
      </h1>
      <div className=" mt-8 h-auto ">
        <div className=" my-4 mx-32 box-border flex justify-evenly rounded-3xl border-2 border-dark-primary p-6">
          <div className="flex flex-col items-center rounded-lg border-2 bg-primary p-6">
            <h1 className="text-center font-sans text-4xl font-semibold text-dark-primary">
              DAILY
            </h1>

              <div className=" m-2 rounded-lg bg-background p-4 text-center text-3xl font-semibold text-dark-primary">
                XX : XX : XX
              </div>
          ...
          <div className="m-4 w-1/2 rounded-lg border-2 bg-primary p-8 font-sans drop-shadow-2xl">
            <div>
              <div className=" mt-4 flex flex-row">
                <h1 className="p-3 text-2xl font-semibold text-dark-primary">
                  Last 7 days Average Duration
                </h1>
                <div className="ml-8 w-1/3 rounded-lg bg-background">.</div>
              </div>
              <div>
                <h1 className="m-4 text-2xl font-semibold text-dark-primary">Last 7 days:</h1>
              </div>

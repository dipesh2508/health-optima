...
const HtmlRenderer = ({ content, className = "" }: HtmlRendererProps) => {
    return (
      <div
       className={`prose prose-lg max-w-none text-justify font-['Arial'] text-slate-800
         ...
         prose-p:mb-0 prose-p:mt-0 prose-p:leading-7 prose-p:font-['Arial']
         ...
         prose-li:mb-0 prose-li:mt-1 prose-li:leading-7 prose-li:font-['Arial']

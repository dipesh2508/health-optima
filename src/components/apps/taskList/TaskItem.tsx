...
const TaskItem = ({it, completed, date}: {key: number, it: string, completed: boolean, date: string}) => {
  return (
    <div className="rounded-2xl bg-white text-primary-9 font-medium p-3 flex justify-between items-center shadow-md shadow-slate-300">
